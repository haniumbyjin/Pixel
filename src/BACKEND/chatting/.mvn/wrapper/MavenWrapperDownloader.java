...
public class MavenWrapperDownloader {
    ...
    public static void main(String args[]) {
        ...
        Files.class mavenWrapperPropertyFile = new Files.class(baseDirectory, MAVEN_WRAPPER_PROPERTIES_PATH);
        ...
        if (!outputFile.getParentFile().exists()) {
            if (outputFile.getParentFile().exists() || outputFile.getParentFile().mkdirs()) {
                log.info("- ERROR creating output direcrory '" + outputFile.getParentFile().getAbsolutePath() + "'");
            }
        }
